...
{-# LINE 2 "./Graphics/UI/Gtk/MenuComboToolbar/TearoffMenuItem.chs" #-}
-- -*-haskell-*-
...
{-# LINE 71 "./Graphics/UI/Gtk/MenuComboToolbar/TearoffMenuItem.chs" #-}


{-# LINE 73 "./Graphics/UI/Gtk/MenuComboToolbar/TearoffMenuItem.chs" #-}
...
{-# LINE 84 "./Graphics/UI/Gtk/MenuComboToolbar/TearoffMenuItem.chs" #-}

foreign import ccall unsafe "gtk_tearoff_menu_item_new"
  gtk_tearoff_menu_item_new :: (IO (Ptr Widget))
