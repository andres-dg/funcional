...
comboBoxEntrySetTextColumn self textColumn =
  (\(ComboBoxEntry arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_combo_box_entry_set_text_column argPtr1 arg2)
...
comboBoxEntryGetTextColumn self =
  ...
  (\(ComboBoxEntry arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_combo_box_entry_get_text_column argPtr1)
...
comboBoxEntryGetActiveText self = do
  strPtr <- (\(ComboBox arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_combo_box_get_active_text argPtr1) (toComboBox self)
