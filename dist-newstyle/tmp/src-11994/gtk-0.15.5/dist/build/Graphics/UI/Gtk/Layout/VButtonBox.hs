...
{-# LINE 2 "./Graphics/UI/Gtk/Layout/VButtonBox.chs" #-}
-- -*-haskell-*-
...
{-# LINE 81 "./Graphics/UI/Gtk/Layout/VButtonBox.chs" #-}


{-# LINE 83 "./Graphics/UI/Gtk/Layout/VButtonBox.chs" #-}
...
vButtonBoxNew =
  ...
  gtk_vbutton_box_new
{-# LINE 94 "./Graphics/UI/Gtk/Layout/VButtonBox.chs" #-}

foreign import ccall unsafe "gtk_vbutton_box_new"
  gtk_vbutton_box_new :: (IO (Ptr Widget))
