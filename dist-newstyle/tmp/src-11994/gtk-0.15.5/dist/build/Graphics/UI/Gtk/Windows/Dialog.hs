...
dialogRun self =
  liftM toResponse $
  (\(Dialog arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_run argPtr1)
...
dialogResponse self responseId =
  (\(Dialog arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_response argPtr1 arg2)
...
dialogAddButton self buttonText responseId =
  ...
  (\(Dialog arg1) arg2 arg3 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_add_button argPtr1 arg2 arg3)
...
dialogAddActionWidget self child responseId =
  (\(Dialog arg1) (Widget arg2) arg3 -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_dialog_add_action_widget argPtr1 argPtr2 arg3)
...
dialogGetHasSeparator self =
  liftM toBool $
  (\(Dialog arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_get_has_separator argPtr1)
{-# LINE 274 "./Graphics/UI/Gtk/Windows/Dialog.chs" #-}
    (toDialog self)
...
dialogSetHasSeparator self setting =
  (\(Dialog arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_set_has_separator argPtr1 arg2)
{-# LINE 283 "./Graphics/UI/Gtk/Windows/Dialog.chs" #-}
    (toDialog self)
    (fromBool setting)
...
dialogSetDefaultResponse self responseId =
  (\(Dialog arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_set_default_response argPtr1 arg2)
...
dialogSetResponseSensitive self responseId setting =
  (\(Dialog arg1) arg2 arg3 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_set_response_sensitive argPtr1 arg2 arg3)
...
dialogGetResponseForWidget self widget = liftM toResponse $
  (\(Dialog arg1) (Widget arg2) -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_dialog_get_response_for_widget argPtr1 argPtr2)
...
dialogAlternativeDialogButtonOrder (Just screen) = liftM toBool $
  (\(Screen arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_alternative_dialog_button_order argPtr1) screen
dialogAlternativeDialogButtonOrder Nothing = liftM toBool $
  (\(Screen arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_alternative_dialog_button_order argPtr1) (Screen nullForeignPtr)
...
dialogSetAlternativeButtonOrderFromArray self newOrder =
  ...
  (\(Dialog arg1) arg2 arg3 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_set_alternative_button_order_from_array argPtr1 arg2 arg3)
...
dialogGetWidgetForResponse self responseId =
    ...
    (\(Dialog arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_dialog_get_widget_for_response argPtr1 arg2)
{-# LINE 371 "./Graphics/UI/Gtk/Windows/Dialog.chs" #-}
      (toDialog self)
      (fromResponse responseId)
{-# LINE 394 "./Graphics/UI/Gtk/Windows/Dialog.chs" #-}
...
foreign import ccall unsafe "gtk_dialog_get_has_separator"
  gtk_dialog_get_has_separator :: ((Ptr Dialog) -> (IO CInt))

foreign import ccall safe "gtk_dialog_set_has_separator"
  gtk_dialog_set_has_separator :: ((Ptr Dialog) -> (CInt -> (IO ())))
