...
{-# LINE 2 "./Graphics/UI/Gtk/Misc/DrawingArea.chs" #-}
-- -*-haskell-*-
...
{-# LINE 94 "./Graphics/UI/Gtk/Misc/DrawingArea.chs" #-}

import Graphics.UI.Gtk.General.Structs (widgetGetDrawWindow, widgetGetSize)



{-# LINE 99 "./Graphics/UI/Gtk/Misc/DrawingArea.chs" #-}
...
{-# LINE 110 "./Graphics/UI/Gtk/Misc/DrawingArea.chs" #-}
...
foreign import ccall unsafe "gtk_drawing_area_new"
  gtk_drawing_area_new :: (IO (Ptr Widget))
