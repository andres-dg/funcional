...
radioButtonNewFromWidget group =
  makeNewObject mkRadioButton $
  liftM (castPtr :: Ptr Widget -> Ptr RadioButton) $
  (\(RadioButton arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_radio_button_new_from_widget argPtr1)
...
radioButtonNewWithLabelFromWidget group label =
  ...
  liftM (castPtr :: Ptr Widget -> Ptr RadioButton) $
  withUTFString label $ \labelPtr ->
  (\(RadioButton arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_radio_button_new_with_label_from_widget argPtr1 arg2)
...
radioButtonNewWithMnemonicFromWidget group label =
  ...
  liftM (castPtr :: Ptr Widget -> Ptr RadioButton) $
  withUTFString label $ \labelPtr ->
  (\(RadioButton arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_radio_button_new_with_mnemonic_from_widget argPtr1 arg2)
...
radioButtonSetGroup self group =
  (\(RadioButton arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_radio_button_get_group argPtr1) group >>= \groupGSList ->
  (\(RadioButton arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_radio_button_set_group argPtr1 arg2)
...
radioButtonGetGroup self =
  (\(RadioButton arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_radio_button_get_group argPtr1)
