...
tooltipSetMarkup self markup =
  ...
  (\(Tooltip arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_tooltip_set_markup argPtr1 arg2)
...
tooltipSetText self text =
  ...
  (\(Tooltip arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_tooltip_set_text argPtr1 arg2)
...
tooltipSetIcon self pixbuf =
  (\(Tooltip arg1) (Pixbuf arg2) -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_tooltip_set_icon argPtr1 argPtr2)
...
tooltipSetIconFromStock self id size =
  ...
  (\(Tooltip arg1) arg2 arg3 -> withForeignPtr arg1 $ \argPtr1 ->gtk_tooltip_set_icon_from_stock argPtr1 arg2 arg3)
...
tooltipSetIconFromIconName self iconName size =
  ...
  (\(Tooltip arg1) arg2 arg3 -> withForeignPtr arg1 $ \argPtr1 ->gtk_tooltip_set_icon_from_icon_name argPtr1 arg2 arg3)
...
tooltipSetCustom self customWidget =
  (\(Tooltip arg1) (Widget arg2) -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_tooltip_set_custom argPtr1 argPtr2)
...
tooltipTriggerTooltipQuery display =
  (\(Display arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_tooltip_trigger_tooltip_query argPtr1)
...
tooltipSetTipArea self rect =
  with rect $ \ rectPtr ->
  (\(Tooltip arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_tooltip_set_tip_area argPtr1 arg2)
...
tooltipSetIconFromGIcon tooltip icon size =
  (\(Tooltip arg1) (Icon arg2) arg3 -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_tooltip_set_icon_from_gicon argPtr1 argPtr2 arg3)
