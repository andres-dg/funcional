...
{-# LINE 2 "./Graphics/UI/Gtk/Scrolling/HScrollbar.chs" #-}
-- -*-haskell-*-
...
{-# LINE 66 "./Graphics/UI/Gtk/Scrolling/HScrollbar.chs" #-}


{-# LINE 68 "./Graphics/UI/Gtk/Scrolling/HScrollbar.chs" #-}
...
hScrollbarNew adjustment =
  ...
  (\(Adjustment arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_hscrollbar_new argPtr1)
{-# LINE 81 "./Graphics/UI/Gtk/Scrolling/HScrollbar.chs" #-}
    adjustment
...
foreign import ccall unsafe "gtk_hscrollbar_new"
  gtk_hscrollbar_new :: ((Ptr Adjustment) -> (IO (Ptr Widget)))
