...
imContextSimpleNew =
  ...
  liftM castPtr gtk_im_context_simple_new
...
imContextSimpleAddTable self table maxSeqLen nSeqs = do
  ...
  withArray (concatMap (\(x,y) -> [x, y]) tableList) $ \(tablePtr :: Ptr CString) ->
      (\(IMContextSimple arg1) arg2 arg3 arg4 -> withForeignPtr arg1 $ \argPtr1 ->gtk_im_context_simple_add_table argPtr1 arg2 arg3 arg4)
