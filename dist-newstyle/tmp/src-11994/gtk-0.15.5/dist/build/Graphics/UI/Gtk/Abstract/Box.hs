...
boxPackStartDefaults self widget =
  (\(Box arg1) (Widget arg2) -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_box_pack_start_defaults argPtr1 argPtr2)
...
boxPackEndDefaults self widget =
  (\(Box arg1) (Widget arg2) -> withForeignPtr arg1 $ \argPtr1 ->withForeignPtr arg2 $ \argPtr2 ->gtk_box_pack_end_defaults argPtr1 argPtr2)
