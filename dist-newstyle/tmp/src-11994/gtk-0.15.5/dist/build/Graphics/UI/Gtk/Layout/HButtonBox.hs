...
{-# LINE 2 "./Graphics/UI/Gtk/Layout/HButtonBox.chs" #-}
-- -*-haskell-*-
...
{-# LINE 81 "./Graphics/UI/Gtk/Layout/HButtonBox.chs" #-}


{-# LINE 83 "./Graphics/UI/Gtk/Layout/HButtonBox.chs" #-}
...
hButtonBoxNew =
  ...
  gtk_hbutton_box_new
{-# LINE 94 "./Graphics/UI/Gtk/Layout/HButtonBox.chs" #-}

foreign import ccall unsafe "gtk_hbutton_box_new"
  gtk_hbutton_box_new :: (IO (Ptr Widget))
