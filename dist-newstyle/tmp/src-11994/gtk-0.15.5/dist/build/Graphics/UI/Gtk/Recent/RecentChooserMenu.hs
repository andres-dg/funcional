...
{-# LINE 2 "./Graphics/UI/Gtk/Recent/RecentChooserMenu.chs" #-}
-- -*-haskell-*-
...
{-# LINE 89 "./Graphics/UI/Gtk/Recent/RecentChooserMenu.chs" #-}


{-# LINE 91 "./Graphics/UI/Gtk/Recent/RecentChooserMenu.chs" #-}
...
{-# LINE 117 "./Graphics/UI/Gtk/Recent/RecentChooserMenu.chs" #-}
...
recentChooserMenuNewForManager manager =
  makeNewObject mkRecentChooserMenu $
  liftM (castPtr :: Ptr Widget -> Ptr RecentChooserMenu) $
  (\(RecentManager arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_recent_chooser_menu_new_for_manager argPtr1)
{-# LINE 136 "./Graphics/UI/Gtk/Recent/RecentChooserMenu.chs" #-}
...
foreign import ccall safe "gtk_recent_chooser_menu_new"
  gtk_recent_chooser_menu_new :: (IO (Ptr Widget))

foreign import ccall safe "gtk_recent_chooser_menu_new_for_manager"
  gtk_recent_chooser_menu_new_for_manager :: ((Ptr RecentManager) -> (IO (Ptr Widget)))
