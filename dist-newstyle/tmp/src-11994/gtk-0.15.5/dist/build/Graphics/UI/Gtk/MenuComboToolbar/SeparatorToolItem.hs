...
separatorToolItemSetDraw self draw =
  (\(SeparatorToolItem arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_separator_tool_item_set_draw argPtr1 arg2)
...
separatorToolItemGetDraw self =
  liftM toBool $
  (\(SeparatorToolItem arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_separator_tool_item_get_draw argPtr1)
