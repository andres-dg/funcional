...
{-# LINE 2 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
-- -*-haskell-*-
...
{-# LINE 464 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}



{-# LINE 467 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
...
rcStyleNew =
  ...
  gtk_rc_style_new
{-# LINE 480 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
...
rcStyleCopy self =
  wrapNewGObject mkRcStyle $
  (\(RcStyle arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_rc_style_copy argPtr1)
{-# LINE 492 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    (toRcStyle self)
...
{-# LINE 500 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    filenamePtr
...
rcGetDefaultFiles = do
  aPtr <- gtk_rc_get_default_files
{-# LINE 508 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
...
{-# LINE 517 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
  >>= readUTFString
...
{-# LINE 524 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
  >>= readUTFString
...
rcGetStyle widget =
  ...
  (\(Widget arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_rc_get_style argPtr1)
{-# LINE 535 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    (toWidget widget)
...
rcGetStyleByPaths settings mWidgetPath mClassPath type_ =
  ...
  (\(Settings arg1) arg2 arg3 arg4 -> withForeignPtr arg1 $ \argPtr1 ->gtk_rc_get_style_by_paths argPtr1 arg2 arg3 arg4)
{-# LINE 562 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    settings
    widgetPathPtr
    classPathPtr
    type_
...
{-# LINE 573 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
  >>= readUTFString
...
rcParse filename =
  withUTFString filename $ \filenamePtr ->
  gtk_rc_parse
{-# LINE 584 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    filenamePtr
...
rcParseString rcString =
  ...
  gtk_rc_parse_string
{-# LINE 592 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    rcStringPtr
...
rcReparseAll =
  liftM toBool $
  gtk_rc_reparse_all
{-# LINE 602 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
...
rcReparseAllForSettings settings forceLoad =
  liftM toBool $
  (\(Settings arg1) arg2 -> withForeignPtr arg1 $ \argPtr1 ->gtk_rc_reparse_all_for_settings argPtr1 arg2)
{-# LINE 613 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    (toSettings settings)
    (fromBool forceLoad)
...
rcResetStyles settings =
  (\(Settings arg1) -> withForeignPtr arg1 $ \argPtr1 ->gtk_rc_reset_styles argPtr1)
{-# LINE 628 "./Graphics/UI/Gtk/General/RcStyle.chs" #-}
    (toSettings settings)
...
rcSetDefaultFiles files =
  ...
  gtk_rc_set_default_files ssPtr

foreign import ccall safe "gtk_rc_style_new"
  gtk_rc_style_new :: (IO (Ptr RcStyle))

foreign import ccall safe "gtk_rc_style_copy"
  gtk_rc_style_copy :: ((Ptr RcStyle) -> (IO (Ptr RcStyle)))

foreign import ccall safe "gtk_rc_add_default_file"
  gtk_rc_add_default_file :: ((Ptr CChar) -> (IO ()))

foreign import ccall safe "gtk_rc_get_default_files"
  gtk_rc_get_default_files :: (IO (Ptr (Ptr CChar)))

foreign import ccall safe "gtk_rc_get_im_module_file"
  gtk_rc_get_im_module_file :: (IO (Ptr CChar))

foreign import ccall safe "gtk_rc_get_module_dir"
  gtk_rc_get_module_dir :: (IO (Ptr CChar))

foreign import ccall safe "gtk_rc_get_style"
  gtk_rc_get_style :: ((Ptr Widget) -> (IO (Ptr Style)))

foreign import ccall safe "gtk_rc_get_style_by_paths"
  gtk_rc_get_style_by_paths :: ((Ptr Settings) -> ((Ptr CChar) -> ((Ptr CChar) -> (CULong -> (IO (Ptr Style))))))

foreign import ccall safe "gtk_rc_get_theme_dir"
  gtk_rc_get_theme_dir :: (IO (Ptr CChar))

foreign import ccall safe "gtk_rc_parse"
  gtk_rc_parse :: ((Ptr CChar) -> (IO ()))

foreign import ccall safe "gtk_rc_parse_string"
  gtk_rc_parse_string :: ((Ptr CChar) -> (IO ()))

foreign import ccall safe "gtk_rc_reparse_all"
  gtk_rc_reparse_all :: (IO CInt)

foreign import ccall safe "gtk_rc_reparse_all_for_settings"
  gtk_rc_reparse_all_for_settings :: ((Ptr Settings) -> (CInt -> (IO CInt)))

foreign import ccall safe "gtk_rc_reset_styles"
  gtk_rc_reset_styles :: ((Ptr Settings) -> (IO ()))

foreign import ccall safe "gtk_rc_set_default_files"
  gtk_rc_set_default_files :: ((Ptr (Ptr CChar)) -> (IO ()))
