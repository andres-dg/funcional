...
{-# LINE 2 "./Graphics/UI/Gtk/ModelView/CellRendererProgress.chs" #-}
-- -*-haskell-*-
...
{-# LINE 70 "./Graphics/UI/Gtk/ModelView/CellRendererProgress.chs" #-}


{-# LINE 72 "./Graphics/UI/Gtk/ModelView/CellRendererProgress.chs" #-}
...
{-# LINE 84 "./Graphics/UI/Gtk/ModelView/CellRendererProgress.chs" #-}
...
foreign import ccall safe "gtk_cell_renderer_progress_new"
  gtk_cell_renderer_progress_new :: (IO (Ptr CellRenderer))
